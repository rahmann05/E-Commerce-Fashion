...
-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('AWAITING_PAYMENT', 'PROCESSING', 'SHIPPED', 'DELIVERED', 'CANCELLED');
...
CREATE TABLE "Product" (
    ...
    "sizeStocks" INTEGER[] DEFAULT ARRAY[]::INTEGER[],
    "colors" TEXT[],
